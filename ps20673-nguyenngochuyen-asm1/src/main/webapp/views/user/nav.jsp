		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<a href=""class="nav-link" data-toggle="modal" data-target="#test">Welcom</a> 
							...
							<ul class="dropdown-menu " aria-labelledby="dropdownMenuButton2">
								<c:choose>
									...
									<c:otherwise>
										...
										<li>
											<a class="dropdown-item" href="register">Change Pass</a>
							...
							$
									...
									.then(
											function(data) {
												$('#messageChange')
														.text(
																'Mật khẩu đã được đặt lại, vui lòng kiểm tra hộp thư Email ^^');
												setTimeout(
														function() {
									...
									.fail(
											function(error) {
												$('#messageChange')
														.text(
																'Email của bạn không chính xác, vui lòng kiểm tra lại!! ^^');
											});
						});
	</script>
</body>
