...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index" class="brand-link"> <img
				...
				class="brand-text font-weight-light">Online Entertaiment
					HungSmall</span>
			</a>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open"><a href='<c:url value='admin'></c:url>' class="nav-link">
						...
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="<c:url value='/admin/video?action=view'></c:url>"
									class="nav-link active"> <i class="far fa-circle nav-icon"></i>
										<p>Video Over-view</p>
								</a></li>
								<li class="nav-item"><a href="<c:url value='/admin/video?action=add'></c:url>"
	...
	<script>
		...
		function deleteVideo(href) {
			...
			$.ajax({
				url: '/ps20673-nguyenngochuyen-asm1/admin/video?action=delete&href=' + href
			}).then(function(data) {
				window.location.href = "http://localhost:8080/ps20673-nguyenngochuyen-asm1"/admin/video?action=view";
			}).fail(function(error) {
